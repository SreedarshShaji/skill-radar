                ...
                <div class="col-md-6 col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 align="center">Login as Customer</h2>
                        </div>
                        <div class="panel-body">
                            <form action="login-customer_ser.jsp" method="post">
            ...
            $("#email").focusout(
                    function () {
                        ...
                        if (input.indexOf('@') < 0 || input.indexOf('.') < 0 || input.indexOf('.') < input.indexOf('@') || input.indexOf('@') < 2 || input.indexOf('.') < 5 || input.length - input.indexOf('.') < 3) {
                            ...
                            if (input.indexOf('@') < 0) {
                                modelMessage = "Mail id should contain a '@' symbol.\n";
                            } else if (input.indexOf('.') < 0) {
                                modelMessage += "Mail id should contain a '.' symbol.\n";
                            } else if (input.indexOf('@') < 2) {
                                modelMessage += "Mail id must be atleast 2 characters long (before the @ symbol).\n";
                            } else if (input.indexOf('.') < 5) {
                                modelMessage += "Domain name must be atleast 2 characters long (after the @ symbol and before .).\n";
                            } else if (input.length - input.indexOf('.') < 3) {
                                modelMessage += "Possible error after the . sign.";
                            }
